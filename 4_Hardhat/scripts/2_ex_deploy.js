...
async function main() {
  ...
  // Your code here!
  hardhat_signers = await hre.ethers.getSigners()
  signer1 = hardhat_signers[0]
  ...
  // Your code here!
  contract = await hre.ethers.getContractAt(contractName, contractAddress, signer1)
